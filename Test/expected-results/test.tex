...
\usepackage[pdftitle={A Christmas Carol},
 pdfauthor={Charles Dickens}]{hyperref}
\hyperbaseurl{}
...
\author{Charles Dickens}\makeatletter 
\makeatletter
...
The Original Edition of A CHRISTMAS CAROL has been out of print for many years, and this Edition is a reprint from the stereotype plates of that Edition.
  \begin{titlepage}
  \begin{docTitle}  \begin{titlePart} A Christmas carol. in prose. \end{titlePart} \begin{titlePart} being {\itshape A Ghost Story of Christmas}\end{titlePart} \end{docTitle} \begin{byline} by \textit{Charles Dickens}.\end{byline} \begin{byline} With illustrations by John Leech\end{byline} \begin{docImprint} London: Chapman and Hall, Ltd. 1893.\end{docImprint}
  \end{titlepage}
  \cleardoublepage
...
\item[{Stave I}]Marley's ghost \hyperref[S1]{1}
...
\end{description} \mainmatter  \section*{(Bits of) A CHRISTMAS CAROL, and other things} 
...
wavyunderline\tabcellsep This is \uwave{wavyunderline} effect\\
doubleunderline\tabcellsep This is \uuline{doubleunderline} effect\\
subscript\tabcellsep This is \textsubscript{subscript} effect\\
superscript\tabcellsep This is \textsuperscript{superscript} effect\\
bold italic red, done separately\tabcellsep {\bfseries {\itshape\bfseries {\itshape\bfseries\color{red}rend test 1}}}\\
bold italic smallcaps\tabcellsep {\itshape\bfseries\scshape rend test 1} \footnote{Cairns 2003: 11. My work is Muellner 1996.}\end{longtable} \par
...
Languages: \textit{Deutsch}; \textit{Italiano}; \textit{Español}; \textit{Français}; \textit{Portugues}; \textit{Russian}; \textit{Svenska}; {\textJapanese 日本語}; {\textChinese 中文}.
...
\section[{Footnotes and endnotes}]{Footnotes and endnotes}
...
Iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod\footnote{It is time to begin the beguine.} Iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod\par
Iriure dolor in hendrerit in vulputate\endnote{Not Vulture} velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit\endnote{Not Blandings} praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
\section[{Assorted elements and links}]{Assorted elements and links}\par
\textbf{Fit the first} The \texttt{<emph>} element is used for linguistic emph\textit{asis}. ‘highlighting’ (\texttt{<soCalled>}) nor with \textit{shouting} (\texttt{<mentioned>}), \textit{transmogrification}, (a technical \texttt{<term>}), for which the \texttt{<gloss>} tag might be used to supply  \textit{a technical definition}).\par
Now for some links! We will start by cross-referring to a later section.\par
Here is a simple \texttt{<ptr>} to it: \textit{\hyperref[P1]{9. Lists}}. Here is a simple \texttt{<ref>}, a \hyperref[P1]{reference to it}.\par
An \xref{http://www.bbc.co.uk}{external link} as ref and as ptr: \url{http://www.bbc.co.uk} and \url{http://www.ox.ac.uk/}.
...
\begin{longtable}{P{0.32331288343558284\textwidth}P{0.13558282208588956\textwidth}P{0.2085889570552147\textwidth}P{0.17208588957055215\textwidth}P{0.010429447852760737\textwidth}}
 \hline\endfoot\hline\endlastfoot \endfirsthead \multicolumn{3}{c}{
          ...
          (cont.)}\\\hline \endhead \caption{
            TEI Span Sample
          }\\ \hline \rowcolor{label}\multicolumn{2}{){\columncolor{label}}l}{Spans {\bfseries Horizontally}}\tabcellsep Header 3\tabcellsep \multicolumn{2}{){\columncolor{label}}l}{Spans {\bfseries Horizontally}}\\\hline 
Spans {\bfseries Vertically}\tabcellsep a\tabcellsep b\tabcellsep c\tabcellsep d\\
e\tabcellsep \multicolumn{2}{l}{Spans {\bfseries both}}\tabcellsep f\\
g\tabcellsep g\\
i\tabcellsep j\tabcellsep \multicolumn{2}{l}{Spans {\bfseries Horizontally}}\\
k\tabcellsep l\tabcellsep m\tabcellsep n\tabcellsep o\end{longtable} \par
 
\section[{Lists}]{Lists}\label{P1}\par
Various sorts of list are legal within paragraphs, and you can reference \hyperref[birds]{items in lists}... \begin{enumerate}
\item Dogs
\item Zebras
\item \label{birds}Birds
\item Cats
...
\item third item 
\end{itemize} \par
What's wrong with this list?\begin{description}

\item[{apricot}]\hspace{1em}\hfill\linebreak
\begin{itemize}
...
\item three
\end{itemize} 
\item[{banana}]\hspace{1em}\hfill\linebreak
\begin{itemize}
\item one
\item two
\item three
...
\item \hyperref[thisQuotation]{Quotation}
\item \hyperref[thisCitation]{Citation}
\item \hyperref[thisParagraph]{Paragraph}
\item \hyperref[thisReference]{Reference}
\item \hyperref[movingAnchor]{Anchor}
\item \hyperref[thisTitle]{Title}
\end{itemize} \par
...
\begin{quote}
\label{thisCitation} \label{movingAnchor} \label{thisQuotation}\par
\label{thisParagraph}Something longer. Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet.\par
\begin{biblfree} \label{thisReference}In \label{thisTitle}\textit{Somewhere}.\end{biblfree}
\end{quote}

\section[{Choice, sic, corr, reg, orig}]{Choice, sic, corr, reg, orig}\par
voro þav sammędd syskin in heilagri {\hskip1pt}\\{} olafr konvngr ok fyrnefnd [ {\corr gvnnhilldr}].\par
...
\end{itemize} 
\section[{divs with no heads}]{divs with no heads}\par
Ampersands: Fit the first\& Fit the first\& more Fit the first\&amp; more Fit the first\&\& Fit the first\&quot; Fit the first @ \xref{http://www.example.com/?foo=bar&bar=foo&\#3}{http://www.example.com/?foo=bar\&bar=foo\&\#3}.\par\bgroup\exampleFont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}Ampersands:\mbox{}\newline 
{<\textbf{seg}>}Fit the first\&{</\textbf{seg}>}\mbox{}\newline 
\hspace*{6pt}{<\textbf{seg}>}Fit the first\& more{</\textbf{seg}>}\mbox{}\newline 
\hspace*{6pt}{<\textbf{seg}>}Fit the first\&amp; more{</\textbf{seg}>}\mbox{}\newline 
\hspace*{6pt}{<\textbf{seg}>}Fit the first\&\&{</\textbf{seg}>}\mbox{}\newline 
\hspace*{6pt}{<\textbf{seg}>}Fit the first\&quot; (as opposed to \&quot;){</\textbf{seg}>}\mbox{}\newline 
\hspace*{6pt}{<\textbf{seg}>}Fit the first @ {<\textbf{ref}\hspace*{6pt}{target}="{http://www.example.com/?foo=bar\&bar=foo\&\#3}">}http://www.example.com/?foo=bar\&bar=foo\&\#3{</\textbf{ref}>}\mbox{}\newline 
\hspace*{6pt}{</\textbf{seg}>}.\mbox{}\newline 
