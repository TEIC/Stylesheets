...
\hspace*{6pt}{<\textbf{seg}>}Fit the first @ {<\textbf{ref}\mbox{}\newline 
\hspace*{6pt}\hspace*{6pt}\hspace*{6pt}\hspace*{6pt}{target}="{http://www.example.com/?foo=bar\&bar=foo\&\#3}">}http://www.example.com/?foo=bar\&bar=foo\&\#3{</\textbf{ref}>}\mbox{}\newline 
