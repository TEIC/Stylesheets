...
DIRS=bibtex cocoa common docx dtd docbook epub epub3 fo html wordpress markdown html5 json latex latex nlm odd odds odt pdf profiles/default rdf relaxng rnc schematron slides tbx tcp tite tools txt html xsd xlsx pdf
